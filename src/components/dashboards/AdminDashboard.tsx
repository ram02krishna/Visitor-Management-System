...
import { AlertCircle, Camera, User, Clipboard } from "lucide-react";
  ...
  return (
    <div className="animate-fadeIn">
      ...
      <div className="mb-8 flex flex-wrap gap-4">
        ...
        <Button variant="outline" onClick={() => navigate("/app/register-visitor")}>
          <User className="mr-2 h-4 w-4" />
          Register Visitor
        </Button>
        <Button variant="outline" onClick={() => navigate("/app/scan")}>
