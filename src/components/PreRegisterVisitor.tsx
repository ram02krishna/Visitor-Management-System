...
export function PreRegisterVisitor() {
  ...
  const onSubmit = async (formData: PreRegisterFormData) => {
    ...
    try {
      ...
      setSuccessMessage("Visitor pre-registered successfully! They will receive a QR code once approved.")
      ...
      <div className="px-4 sm:px-6 lg:px-8 py-12">
        <div className="max-w-2xl mx-auto text-center">
          <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-8">
            ...
            <p className="text-red-600 dark:text-red-400">Only guards and administrators can pre-register visitors.</p>
          </div>
        </div>
      </div>
    )
      ...
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Pre-register Visitor</h1>
          </div>
          <p className="text-sm text-gray-600 dark:text-slate-400 ml-14">
            Pre-register a visitor for approval. They'll receive a QR code once a guard or admin approves their visit.
          </p>
        </div>
