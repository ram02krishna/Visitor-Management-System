        ...
        <div className="relative z-10 flex flex-col justify-center px-12 xl:px-20 py-12 w-full h-full text-white">
          <div className="glass-dark border border-white/10 rounded-3xl p-8 max-w-lg shadow-2xl animate-slideInLeft">
            ...
            <h1 className="text-4xl xl:text-5xl font-extrabold tracking-tight mb-6">
              Start managing<br />visitors better, today.
            </h1>

            <p className="text-lg text-indigo-100/80 mb-10 leading-relaxed font-light">
              Create an account to gain instant access to seamless visitor registration, powerful analytics, and bulletproof security.
            </p>

            <div className="space-y-5">
              {[
                { title: "Quick Setup", desc: "Get started in minutes with intuitive configuration." },
                { title: "Campus Collaboration", desc: "Easily invite guards, admins, and faculty/staff." },
              ].map((feature, i) => (
                <div key={i} className="flex items-start gap-4">
                  <div className="p-2.5 rounded-xl bg-white/10 mt-1">
        ...
        <div className="w-full max-w-md sm:max-w-lg mx-auto relative z-10 sm:py-8">
          ...
          <div className="text-center lg:text-left mb-6 sm:mb-8 px-5 sm:px-0 animate-fadeInUp">
            <div className="lg:hidden flex justify-center mb-6">
              <div className="p-3 bg-indigo-100 dark:bg-indigo-900/40 rounded-2xl shadow-sm border border-indigo-200 dark:border-indigo-800/50">
          ...
          <div className="sm:glass px-5 sm:px-8 py-2 sm:py-8 sm:rounded-3xl sm:shadow-xl sm:border border-gray-100/50 dark:border-slate-800 animate-fadeInUp" style={{ animationDelay: '0.1s' }}>

            {success && (
              <div className="mb-6 p-4 bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800/50 text-emerald-600 dark:text-emerald-400 rounded-xl text-sm flex items-center gap-3 animate-fadeIn">
            ...
            <form className="space-y-4 sm:space-y-5" onSubmit={handleSubmit}>
              <div className="animate-fadeInUp" style={{ animationDelay: '0.2s' }}>
                <label htmlFor="name" className="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-1.5 ml-1">
                  Full Name
                </label>
                <input
                  id="name" name="name" type="text" required value={name} onChange={(e) => setName(e.target.value)}
                  className="block w-full px-4 py-3 bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-700 rounded-xl text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-sky-500/50 focus:border-sky-500 transition-all duration-300 hover:border-gray-300"
              ...
              <div className="animate-fadeInUp" style={{ animationDelay: '0.3s' }}>
                <label htmlFor="department" className="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-1.5 ml-1">
                  Department
                </label>
                <div className="relative">
                  ...
                  <select
                    id="department" name="department" required value={departmentId} onChange={(e) => setDepartmentId(e.target.value)}
              ...
              <div className="animate-fadeInUp grid gap-5 grid-cols-1 sm:grid-cols-2" style={{ animationDelay: '0.4s' }}>
                <div>
                  ...
                  <div className="relative">
                    <input
                      id="password" name="password" type={showPassword ? "text" : "password"} autoComplete="new-password" required value={password} onChange={(e) => setPassword(e.target.value)}
                      className="block w-full px-4 py-3 bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-700 rounded-xl text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-sky-500/50 focus:border-sky-500 transition-all duration-300 hover:border-gray-300 pr-10"
                      placeholder="••••••••"
                    />
                  ...
                  {password.length > 0 && (
                    <div className="mt-2.5 px-1 animate-fadeIn">
                      ...
                      <p className={`text-xs mt-1.5 font-medium ${strength >= 3 ? 'text-emerald-600 dark:text-emerald-400' : 'text-gray-500 dark:text-slate-400'}`}>
                ...
                <div>
                  <label htmlFor="confirmPassword" className="block text-sm font-medium text-gray-700 dark:text-slate-300 mb-1.5 ml-1">
                    Confirm Password
                  </label>
                  <div className="relative">
                    <input
                      id="confirmPassword" name="confirmPassword" type={showConfirmPassword ? "text" : "password"} autoComplete="new-password" required value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)}
                      className="block w-full px-4 py-3 bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-700 rounded-xl text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-sky-500/50 focus:border-sky-500 transition-all duration-300 hover:border-gray-300 pr-10"
                      placeholder="••••••••"
                    />
              ...
              <div className="pt-4 animate-fadeInUp" style={{ animationDelay: '0.5s' }}>
                ...
                >
                  {isLoading ? <span className="loading-spinner w-5 h-5 mr-2"></span> : "Create Account"}
