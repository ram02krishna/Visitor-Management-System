      ...
      >
        ...
        <div className="p-4 xs:p-5 sm:p-6 relative z-10 flex-1 flex flex-col">
          ...
          <div className="mt-auto pt-4 sm:pt-5">
            ...
            <h3 className="mt-1 text-[10px] sm:text-xs sm:text-sm font-bold text-gray-400 dark:text-slate-500 tracking-widest uppercase">
              {name}
            </h3>
          </div>
        </div>

        <div className="px-4 xs:px-6 py-2.5 sm:py-3 bg-gray-50/80 dark:bg-slate-800/50 border-t border-gray-100 dark:border-slate-800/60 relative z-10 flex items-center gap-1.5">
