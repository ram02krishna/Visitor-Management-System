...
export function Login() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-slate-950 dark:to-slate-900 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <BackButton />
      <div className="sm:mx-auto sm:w-full sm:max-w-md animate-fadeIn">
        ...
        <h2 className="mt-6 text-center text-3xl font-extrabold bg-gradient-to-r from-sky-600 to-blue-600 dark:from-sky-400 dark:to-blue-400 bg-clip-text text-transparent animate-fadeInUp">
          Campus VMS
        </h2>
        <p className="mt-2 text-center text-sm text-gray-600 dark:text-slate-300 animate-fadeInUp" style={{animationDelay: '0.1s'}}>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md animate-fadeInUp" style={{animationDelay: '0.2s'}}>
        <div className="glass py-8 px-4 shadow-xl sm:rounded-2xl sm:px-10 hover:shadow-2xl transition-all duration-500">
            ...
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  className="appearance-none block w-full px-3 py-2 border border-gray-300 dark:border-slate-600 rounded-lg shadow-sm placeholder-gray-400 dark:placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-sky-500 sm:text-sm bg-white dark:bg-slate-800 text-gray-900 dark:text-slate-100 transition-all duration-300 hover:border-sky-400"
                />
              </div>
            </div>
